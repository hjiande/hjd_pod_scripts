...
log_dir = args.dir
bin_dir = args.bin
grt_bin = "/project/jdhuang/GNSS_software/GREAT/pod_add_tb/build/Bin/"
scp_dir = "/workfs/jdhuang/jdhuang_obs/scripts/great"                       # scripts dir
mod_xml = "/workfs/jdhuang/jdhuang_obs/scripts/great/gnss_tb_gec.xml"       # model xml
...
tool.run_grt_cmd(app_dir=grt_bin, app_name="great_tbedit", xml_path=doy_xml, log_dir="./", log_name="great_tbedit.cmd_log", snx="", sys="GEC",L13="",dir=log_dir, bin=bin_dir)
