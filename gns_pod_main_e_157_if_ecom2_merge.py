...
tool.run_py_cmd(python_version=python_version, python_name=update_xml_py, log_dir=log_dir, log_name="gns_xml_update_xml_lsq1.cmd_log", idst=doy_xml, freq="LC", short=600, jump=80, bad=80)
...
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_podlsq", xml_path=doy_xml, log_dir=log_dir,log_name="great_podlsq_lsq2.cmd_log")
glog.fatal("==========> beg oi.")
...
# update editres
glog.fatal("==========> beg editres.")
tool.run_py_cmd(python_version=python_version, python_name=update_xml_py,     log_dir=log_dir, log_name="gns_xml_update_xml_lsq2.cmd_log", idst=doy_xml, freq="LC", short=600, jump=40, bad=40)
...
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_podlsq", xml_path=doy_xml, log_dir=log_dir, log_name="great_podlsq_lsq3.cmd_log")
glog.fatal("==========> beg oi.")
...
# update editres
glog.fatal("==========> beg editres.")
tool.run_py_cmd(python_version=python_version, python_name=update_xml_py, log_dir=log_dir, log_name="gns_xml_update_xml_lsq3.cmd_log", idst=doy_xml, freq="LC", short=600, jump=40, bad=40)
...
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_podlsq", xml_path=doy_xml, log_dir=log_dir, log_name="great_podlsq_lsq4.cmd_log")
glog.fatal("==========> beg oi.")
...
# update editres
glog.fatal("==========> beg editres.")
tool.run_py_cmd(python_version=python_version, python_name=update_xml_py, log_dir=log_dir, log_name="gns_xml_update_xml_lsq4.cmd_log", idst=doy_xml, freq="LC", short=600, jump=40, bad=40)
...
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_podlsq", xml_path=doy_xml, log_dir=log_dir, log_name="great_podlsq_fix.cmd_log", ambfix="")
glog.fatal("==========> beg oi.")
