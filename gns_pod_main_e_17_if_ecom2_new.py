...
doy_xml = ""
mod_xml = "/workfs/jdhuang/great_projects/e_all/scripts/great/gnss_pod_e_17_if_ecom2_merge.xml"  # model xml
scp_dir = "/workfs/jdhuang/great_projects/e_all/scripts/great"                                   # scripts dir
prj_dir = "/workfs/jdhuang/great_projects/e_all/if_17_ecom2_new"                               # project dir
xml_dir = "/workfs/jdhuang/great_projects/e_all/if_17_ecom2_new/xml"                           # xml file for each day, format is yyyydoy.xml
prj_log = "/workfs/jdhuang/great_projects/e_all/log_13_as_12"                                    # 周跳探测的log文件
...
glog.fatal("==========> beg oi.")
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_oi", xml_path=doy_xml, log_dir=log_dir,
                 log_name="great_oi_lsq4.cmd_log")
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_orbdif", xml_path=doy_xml, log_dir=log_dir,
                 log_name="great_orbdif_lsq4.cmd_log")
...
glog.fatal("==========> beg editres.")
tool.run_py_cmd(python_version=python_version, python_name=update_xml_py, log_dir=log_dir,
                log_name="gns_xml_update_xml_lsq4.cmd_log", idst=doy_xml, freq="LC", short=600, jump=40, bad=40)
tool.run_grt_cmd(app_dir=bin_dir, app_name="great_editres", xml_path=doy_xml, log_dir=log_dir,
                 log_name="great_editres_lsq4.cmd_log")
